										...
										<tr>
											<td colspan="6">	
												...
												<c:if test="${vo.nickname == memberInfo.nickname }">
													<input type="button" class="btn btn-default btn-xs" value="삭제" onclick="${contextPath}/board/delete/${vo.category }/${vo.bno}'">
													<input type="submit" class="btn btn-default btn-xs" value="수정">
												</c:if>
												<input type="button" class="btn btn-default btn-xs" value="목록" onclick="${contextPath}/board/list?category=${vo.category}'">
											</td>
										</tr>
								</table>
								</form>
